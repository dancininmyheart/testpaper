...
If any of these files don't exist, **proceed silently**. Don't flag their absence; don't suggest creating them. The producer skill (`/grill-with-docs`) creates them lazily.
